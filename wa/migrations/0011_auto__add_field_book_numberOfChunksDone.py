...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.numberOfChunksDone'
        db.add_column(u'wa_book', 'numberOfChunksDone',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.numberOfChunksDone'
        db.delete_column(u'wa_book', 'numberOfChunksDone')
    ...
    models = {
        ...
        u'wa.book': {
            ...
            'numberOfChunksDone': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'wa.userhistory': {
            ...
            'logoutTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 10, 0, 0)'}),
